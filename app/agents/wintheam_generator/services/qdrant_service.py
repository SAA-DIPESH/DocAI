...
if __name__ == "__main__":
    ...
    example_anchor_group = {
        "anchor_id": "ANCHOR-001",
        "objective": (
            "Find evidence demonstrating the company's "
            "data protection and GDPR capability."
        ),
        "anchor_query": (
        ...
        "query_variants": [
            ...
            "UK GDPR compliance policies",
            "personal data protection procedures",
        ],
    }

    # Replace this with an actual CompanyId from your Qdrant payload.
    example_company_id = (
        "6a6364bec5731016189ef98b"
    )

    try:
        retrieval_result = retriever.retrieve(
            company_id=example_company_id,
            anchor_group=example_anchor_group,
            top_k=5,
            search_limit=10,
        )
        ...
        print(
            f"Company evidence retrieval failed: {exc}"
        )