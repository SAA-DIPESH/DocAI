...
from app.agents.wintheam_generator.graph.nodes.collect_win_theme import (
    collect_win_theme_node,
)
from app.agents.wintheam_generator.graph.nodes.retrieve_chunk import (
    retrieve_evidence_node,
)
from app.agents.wintheam_generator.graph.nodes.routes_nodes import (
    route_after_extract,
    route_after_retrieve_evidence,
    route_after_select_anchor,
)
from app.agents.wintheam_generator.graph.nodes.select_current_anchor import (
    select_current_anchor_node,
)
from app.agents.wintheam_generator.graph.nodes.wintheam_extract import (
    extract_win_theme_node,
)
from app.agents.wintheam_generator.graph.nodes.wintheam_generator import (
    win_theme_generator_node,
)


def route_after_collection(state: WinThemeState):
    """Continue looping until all anchor groups are processed."""
