...
class ProposalSummaryRepository:
    ...
    def save_proposal_summary(
        ...
        *,
        ...
        Every execution inserts a new document.
        ...
        if not proposal_plan_id:
            raise ValueError(
                "proposal_plan_id is required to save proposal summary."
            )

        if not version_id:
            raise ValueError(
                "version_id is required to save proposal summary."
            )
        ...
        for section in response.get("section_results", []):
            ...
            document["sections"].append(
                {
                    "sectionId": generated.get("SectionId")
                    or section.get("section_id"),
                    "sectionName": generated.get("SectionName")
                    or section.get("section_name"),
                    "generatedContent": generated.get("GeneratedContent"),
                    "generatedSubSections": generated.get(
                        "GeneratedSubSections", []
                    ),
                    "evaluationCriteria": generated.get(
                        "EvaluationCriteria", []
                    ),
                    "internalReview": generated.get(
                        "InternalReview", {}
                    ),
                }
            )
